            ...
            <section class="featured-products">
                ...
                <div class="product-row">
                    ...
                    <article class="product">
                        <div class="product-frame"><img src="http://localhost/eproject/app/assets/data/featured-img-1.jpg" alt="Sản phẩm 1" loading="lazy" /></div>
                        <h3>Sản Phẩm 1</h3>
                    ...
                    <article class="product">
                        <div class="product-frame"><img src="http://localhost/eproject/app/assets/data/featured-img-45.jpg" alt="Sản phẩm 4" loading="lazy" /></div>
                        <h3>Sản Phẩm 4</h3>
