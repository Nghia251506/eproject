...
CALL insert_product('Retro Pendant Light', 7, 30, 'E27', 'Copper', 2000000, 3000000, 20, 6, 'https://example.com/retro-pendant.jpg', 'Pendant lights bring a retro touch to any space with their vintage-inspired design, providing focused lighting for dining or living rooms.');
CALL insert_product('Outdoor LED Floodlight', 9, 30, 'LED', 'Gray', 4000000, 6000000, 30, 8, 'https://example.com/outdoor-led-floodlight.jpg', 'Outdoor LED floodlights are designed to illuminate large areas with bright, energy-efficient light, perfect for security and exterior lighting.');
CALL insert_product('Industrial Wall Sconce', 6, 30, 'E27', 'Black', 2500000, 3500000, 17, 7, 'https://example.com/industrial-wall-sconce.jpg', 'Industrial wall sconces offer a rugged aesthetic with a minimalist design, providing focused lighting for hallways or living rooms.');
CALL insert_product('Contemporary Pendant Light', 7, 30, 'E27', 'Chrome', 3000000, 4500000, 18, 6, 'https://example.com/contemporary-pendant-light.jpg', 'Contemporary pendant lights provide stylish illumination with sleek designs, ideal for modern kitchens, dining areas, or living rooms.');
CALL insert_product('Stylish LED Strip Light', 8, 30, 'LED', 'RGB', 1200000, 2200000, 25, 9, 'https://example.com/stylish-led-strip.jpg', 'LED strip lights offer versatile lighting solutions with customizable colors, perfect for accent lighting in modern homes or entertainment areas.');
CALL insert_product('Outdoor Spotlight', 10, 30, 'LED', 'Black', 6000000, 8000000, 20, 8, 'https://example.com/outdoor-spotlight.jpg', 'Outdoor spotlights are designed for highlighting specific areas in gardens or exteriors, providing bright, directional light for enhanced visibility.');
CALL insert_product('Vintage Wall Sconce', 6, 30, 'E27', 'Bronze', 2200000, 3200000, 19, 7, 'https://example.com/vintage-wall-sconce.jpg', 'Vintage wall sconces bring classic charm with their timeless design, perfect for creating a warm, inviting atmosphere in any room.');
CALL insert_product('Modern LED Ceiling Light', 5, 30, 'LED', 'White', 2800000, 4000000, 23, 5, 'https://example.com/modern-led-ceiling-light.jpg', 'Modern LED ceiling lights provide energy-efficient lighting with a sleek design, perfect for minimalist homes with low ceilings.');
CALL insert_product('Classic Wall Lamp', 6, 30, 'E27', 'Gold', 2400000, 3500000, 20, 7, 'https://example.com/classic-wall-lamp.jpg', 'Classic wall lamps bring timeless elegance to any space, perfect for lighting hallways or bedrooms while adding a touch of sophistication.');
CALL insert_product('Smart LED Bulb', 8, 30, 'LED', 'RGB', 900000, 1200000, 25, 9, 'https://example.com/smart-led-bulb.jpg', 'Smart LED bulbs offer customizable lighting, allowing you to change colors and adjust brightness remotely using a smartphone or voice control.');
CALL insert_product('Luxury Pendant Light', 7, 30, 'E27', 'Gold', 4500000, 6000000, 22, 6, 'https://example.com/luxury-pendant-light.jpg', 'Luxury pendant lights offer both function and beauty, featuring high-end materials and designs to create a focal point in any room.');
CALL insert_product('Minimalist Table Lamp', 2, 30, 'E27', 'Gray', 2200000, 3300000, 18, 3, 'https://example.com/minimalist-table-lamp.jpg', 'Minimalist table lamps provide functional lighting with sleek, modern designs, perfect for workspaces or reading corners in contemporary homes.');
CALL insert_product('Decorative Ceiling Fan Light', 5, 30, 'E27', 'White', 6000000, 8000000, 24, 5, 'https://example.com/decorative-ceiling-fan-light.jpg', 'Decorative ceiling fan lights combine functionality and style, offering cooling and lighting in a single, stylish unit for modern homes.');
CALL insert_product('Modern Track Lighting', 3, 30, 'LED', 'Black', 4800000, 6000000, 21, 4, 'https://example.com/modern-track-lighting.jpg', 'Modern track lighting provides adjustable lighting with multiple heads, perfect for highlighting specific areas like art, furniture, or workspaces.');
CALL insert_product('Outdoor Hanging Lantern', 10, 30, 'E27', 'Bronze', 2800000, 4000000, 19, 8, 'https://example.com/outdoor-hanging-lantern.jpg', 'Outdoor hanging lanterns bring classic charm to patios and gardens, offering decorative and functional lighting for exterior spaces.');
CALL insert_product('Energy-Efficient Ceiling Light', 5, 30, 'LED', 'White', 3500000, 5000000, 23, 5, 'https://example.com/energy-efficient-ceiling-light.jpg', 'Energy-efficient ceiling lights provide bright, even lighting while using less electricity, perfect for modern homes aiming for sustainability.');
CALL insert_product('Vintage Pendant Light', 7, 30, 'E27', 'Copper', 3300000, 4500000, 20, 6, 'https://example.com/vintage-pendant-light.jpg', 'Vintage pendant lights offer a retro aesthetic with modern functionality, perfect for lighting over kitchen islands or dining tables.');
CALL insert_product('Smart Ceiling Light', 5, 30, 'LED', 'White', 5200000, 6800000, 23, 5, 'https://example.com/smart-ceiling-light.jpg', 'Smart ceiling lights can be controlled remotely, offering customizable brightness and color settings, ideal for smart homes with modern designs.');
